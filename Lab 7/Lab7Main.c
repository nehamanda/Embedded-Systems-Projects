...
char EID1[]="NM32773";  // student's EID
char EID2[]="YEP96";  // student's EID
#define SIZE 16
...
const uint16_t Test2[] = {
  0x001F, 0x07FF, 0x07E0, 0xF800, 0xFFFF, 0xFFFF,
  0x001F, 0x07FF, 0x07E0, 0xF800, 0x0000, 0x0000,
  0x001F, 0x07FF, 0x07E0, 0xF800, 0xFFFF, 0xFFFF,
  0x001F, 0x07FF, 0x07E0, 0xF800, 0x0000, 0x0000,
  0x001F, 0x07FF, 0x07E0, 0xF800, 0xFFFF, 0xFFFF,
  0x001F, 0x07FF, 0x07E0, 0xF800, 0x0000, 0x0000
...
//  }
  ...
  for(i=0;i<SIZE;i++){
	...
	IO_Touch();
	ST7735_FillScreen(0);
	ST7735_DrawBitmap(64,80,Test2,6,6);
  while(1){
  }
}